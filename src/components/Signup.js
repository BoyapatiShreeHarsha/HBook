...
const Signup = () => {
  let localhost = "https://hbook-backen.onrender.com";
  ...
  return (
    <div style={{ display: "flex", height: "80vh", backgroundColor: mode === 'dark' ? '#343a40' : 'white', borderColor: mode === 'dark' ? 'white' : 'black', color: mode === 'dark' ? 'white' : 'black',marginLeft:"10px",marginRight:"10px" }}>
      <img src={pic} className="img-fluid pic" alt="No-img" />
      <div className='d-flex justify-content-center flex-column' style={{ flexGrow: "3", flexShrink: "1" }}>
        ...
        <form onSubmit={submitted}>
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="name" name='name' aria-describedby="emailHelp" placeholder='minLength=3' minLength={3} onChange={changing} required />
          </div>
          <div className="mb-3">
            <label htmlFor="email" className="form-label">Email address</label>
            <input type="email" className="form-control" id="email" name='email' onChange={changing} aria-describedby="emailHelp" required />
          </div>
          <div className="mb-3">
            <label htmlFor="password" className="form-label">Password</label>
            <input type="password" className="form-control" id="password" name='password' onChange={changing} placeholder='minLength=5' minLength={5} required />
          </div>
          <div className="mb-3">
            <label htmlFor="cpassword" className="form-label">Confirm Password</label>
            <input type="password" className="form-control" id="cpassword" name='cpassword' onChange={changing} placeholder='minLength=5' minLength={5} required />
          </div>
